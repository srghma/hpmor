...
\resizebox{!}{\rationalh}{\textls[50]{វិធីសាស្ត្រ}}%
  \hfil\resizebox{!}{\rationalh}{\textls[50]{OF}}%
  \vskip 2mm%
  \resizebox{.95\hptitlewidth}{!}{\textls[20]{RATIONALITY}}%
  \vskip 8mm%
  \color{white}%
  \resizebox{.5\hptitlewidth}{!}{\textls[50]{\scshape {}ដោយ Eliezer Yudkowsky}}%
  \vfill%
  \textls[50]{\scshape #2}%
  \color{black}%
  \vskip 1cm\ %
}
\providecommand{\fullvolumetitle}[1]{សៀវភៅ #1: \volumetitle}
